    ...
    return (
        <div className="space-y-8 animate-in fade-in zoom-in-95 duration-200">
            <div>
                ...
                <p className="text-sm font-medium text-slate-500 mt-1">Manage your contact information and regional settings.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                    ...
                    <input 
                        ...
                        className="w-full bg-slate-50 border border-slate-100 p-4 rounded-2xl text-sm font-bold text-slate-400 cursor-not-allowed outline-none transition-all"
                    />
                    <p className="text-[10px] font-bold text-slate-400 px-1 mt-1">Email cannot be changed directly.</p>
                </div>
