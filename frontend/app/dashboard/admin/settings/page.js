...
export default function SystemSettings() {
    ...
    if (loading) return (
        <AdminLayout>
            <div className="p-20 text-center text-slate-400 font-black uppercase tracking-widest text-[10px] animate-pulse">Initializing System Configuration...</div>
        </AdminLayout>
    );
        ...
        <AdminLayout>
            <div className="space-y-8 max-w-6xl mx-auto">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div>
                        <h1 className="text-3xl font-black text-slate-800 tracking-tight leading-none mb-1">System Settings</h1>
                    ...
                    {activeTab !== 'account' && (
                        <div className="flex gap-4">
                            ...
                            <button 
                                onClick={handleSave}
                                disabled={saving}
                                className="flex items-center gap-2 px-8 py-3 bg-blue-600 text-white rounded-2xl font-black text-sm shadow-xl shadow-blue-100 hover:-translate-y-1 transition-all disabled:opacity-50"
                            >
                                ...
                                <div className="space-y-12">
                                    ...
                                    <section>
                                        <div className="flex items-center gap-3 mb-8">
                                            ...
                                            <h3 className="text-xl font-black text-slate-800 tracking-tight">Personal Identity</h3>
                                        </div>
                                        <form onSubmit={handleUpdateProfile} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div className="space-y-2">
                                                ...
                                                <input 
                                                    ...
                                                    className="w-full px-5 py-3 bg-slate-50 border border-slate-100 rounded-xl text-sm font-bold text-slate-800 outline-none focus:ring-4 focus:ring-blue-100 transition-all"
                                                />
                                            </div>
                                            <div className="space-y-2">
                                            ...
                                            <div className="md:col-span-2 pt-2">
                                                <button 
                                                    ...
                                                    className="px-8 py-3 bg-slate-800 text-white rounded-xl font-black text-xs hover:-translate-y-1 transition-all disabled:opacity-50"
                                                >
                                    ...
                                    <section>
                                        <div className="flex items-center gap-3 mb-8">
                                            ...
                                            <h3 className="text-xl font-black text-slate-800 tracking-tight">Security Access</h3>
                                        </div>
                                        <form onSubmit={handleUpdatePassword} className="space-y-6">
                                            ...
                                            <div className="pt-2">
                                                <button 
                                                    type="submit"
                                                    disabled={updatingAccount}
                                                    className="px-8 py-3 bg-amber-600 text-white rounded-xl font-black text-xs hover:-translate-y-1 transition-all disabled:opacity-50"
                                                >
                                ...
                                <>
                                        ...
                                        <div key={setting.key} className="flex flex-col md:flex-row md:items-center justify-between gap-6 group">
                                            <div className="flex-1 max-w-md">
                                                <div className="flex items-center gap-2 mb-1">
                                                    <label className="text-sm font-black text-slate-800 tracking-tight uppercase tracking-widest text-[11px] opacity-80">{setting.key.replace(/([A-Z])/g, ' $1')}</label>
                                    ...
                                    {activeTab === 'payment' && (
                                        <div className="mt-12 p-6 bg-slate-50 rounded-3xl border border-slate-100 flex items-start gap-4">
                                            ...
                                            <div>
                                                <h5 className="text-sm font-black text-slate-800 mb-1 leading-none uppercase tracking-tight">Security Protocol</h5>
